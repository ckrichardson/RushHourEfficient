/** @file RushHour.cpp
* @mainpage Rush Hour
* @author Joseph Yott, Sean Griffith, Clifford Richards
* @version 2.00
...
struct Vehicle
{
  int length; //size of vehicle - 3 = truck, 2 = car
  char id; //what iteration of car - ie. 'a' 'b' ...
  char orientation; //direction vehicle is facing - H = horizontal, V = vertical
};
